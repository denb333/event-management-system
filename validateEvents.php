...
function validateEvents($input_method, &$formdata, &$errors) {
    ...
    $formdata['UserID'] = filter_input($input_method, "UserID", FILTER_SANITIZE_NUMBER_INT);
    ...
    if ($formdata['UserID'] === ""){
        ...
        if ($UserID < 0 || $capacity > 999999) {
    }
        $errors['UserID'] = "UserID required. Cannot be a negative value";
    }
