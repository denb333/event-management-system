        ...
        <div class = "content">
            <div class = "container">
                ...
                <form action="createEvent.php" method="POST" class="form-horizontal">
                    ...
                    <button type="submit" class = "btn btn-success pull-right">Create Event <span class="glyphicon glyphicon-send"></span></button>
                    <a class="btn btn-danger navbar-btn" href = "viewEvents.php"><span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a><!--register button-->
                </form>
            </div>
        </div>
