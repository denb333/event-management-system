    ...
    <body>
        ...
        <div class="content">
            <div class="container">
                ...
                <button type="submit" name="createLocation" class="btn btn-success pull-right">Create Location <span class="glyphicon glyphicon-send"></span></button>
                </form>
                <a class="btn btn-danger" href="viewLocations.php"><span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a><!--return/back button-->
            </div>
        </div>
