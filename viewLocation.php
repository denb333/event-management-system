            ...
            <div class = "container">
                ...
                <table class = "table table-hover">
                    ...
                    <tbody>
                        ...
                        . '<a class="edit btn btn-warning" href="editLocationForm.php?id=' . $row['LocationID'] . '">Edit</a> '
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        while ($row) {
                            ...
                            . '</td>';
                            echo '<td>'
                            . '<a class="btn btn-primary" href="viewEvent.php?id='.$row['EventID'].'">View</a> '
                            . '<a class="btn btn-danger" href="deleteEvent.php?id='.$row['EventID'].'">Delete</a> '
                            . '</td>';
                            echo '</tr>';  
