...
class EventTableGateway {
    ...
    public function getEvents($UserID) {
        ...
        $sqlQuery = "SELECT e.*, l.name FROM events e 
                     LEFT JOIN locations l ON e.LocationID = l.LocationID 
    ...
    public function getEventsByUserID($id) {
        // execute a query to get all events
        $sqlQuery = "SELECT e.*, l.username " .
                    "FROM events e " .
                    "LEFT JOIN users l ON e.UserID = l.id " .
                    "WHERE e.UserID=:UserID";
    ...
    public function insert($p) {
        $sql = "INSERT INTO events(Title, Description, StartDate, EndDate, Cost, LocationID, UserID) " .
                "VALUES (:Title, :Description, :StartDate, :EndDate, :Cost, :LocationID, :UserID)";
