            ...
            <div class = "container">
                ...
                <table class = "table table-hover">
                    ...
                    <tbody>
                        ...
                        . '<a class="delete btn btn-primary" href="editLocationForm.php?id=' . $row['LocationID'] . '">Edit</a> '
                        . '<a class="delete btn btn-danger" href="deleteLocation.php?id=' . $row['LocationID'] . '">Delete</a> '
                        . '</td>';
                        echo '</tr>';
                        ?>
                    </tbody>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        while ($row) {
                            ...
                            . '</td>';
                            echo '<td>'
                            . '<a class="view btn btn-primary " href="viewEvent.php?id='.$row['EventID'].'">View</a> '
                            . '<a class="delete btn btn-danger" href="deleteEvent.php?id='.$row['EventID'].'">Delete</a> '
                            . '</td>';
                            echo '</tr>';  
                ...
                ?>
                <a class="btn btn-danger" href="viewLocations.php"><span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a>
            </div>
        </div>
